...
const testimonials = [
  {
    quote: "Traditional fertilizer calculations were pure guesswork. We were either destroying our soil with excess or losing yield from deficiency.",
    author: "Ramesh P.",
    location: "Chitwan, Nepal",
    image: "/farmers/farmer-1.png",
  },
  {
    quote: "A sudden valley frost wiped out 40% of my tomatoes. The national weather report didn't predict it for our specific altitude.",
    author: "Nima S.",
    location: "Mustang, Nepal",
    image: "/farmers/farmer-2.png",
  },
  {
    quote: "I walked 3 hours to the nearest agronomist to show him my dying crops, only to find he was on leave. I lost my entire harvest.",
    author: "Sunita G.",
    location: "Kavre, Nepal",
    image: "/farmers/farmer-3.png",
  },
  {
    quote: "Middlemen took a 30% commission on my ready harvest. I had no direct way to reach the wholesale distributors.",
    author: "Bikash T.",
...
const STORAGE_KEY = "avani-testimonial-positions";
    ...
    <section className="w-full py-20 md:py-28 bg-[#131312] relative">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-16 mb-14 md:mb-20">
        <motion.div 
          ...
          viewport={{ once: true }}
          className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#C4704A]/10 border border-[#C4704A]/20 mb-5"
        >
          <span className="text-xs font-inter tracking-wider text-[#D18B6B] uppercase">The Motivation</span>
        </motion.div>
        <motion.h2 
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        >
          The <span className="text-[#C4704A] italic">problems</span> of the farmer.
        </motion.h2>
      </div>
