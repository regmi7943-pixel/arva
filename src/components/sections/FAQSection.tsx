...
const faqs = [
  {
    ...
    answer: "No. Avani operates primarily offline for field data collection. It syncs with the cloud only when you reach a connection, ensuring you can map fields and take photos in remote areas without issue."
  },
  {
