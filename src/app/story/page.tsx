      ...
      <section className="py-60 px-6 bg-[#1C1C1A]">
        <div className="max-w-4xl mx-auto">
          ...
          <motion.div {...fadeIn} transition={{ ...fadeIn.transition, delay: 0.2 }}>
            ...
            <p className="text-2xl md:text-4xl font-cormorant font-light italic leading-relaxed text-[#D1D1CB]">
              "We had the answer on our phones in 30 seconds. He didn't have that access. <span className="text-[#C4704A] not-italic font-normal">That was the moment Avani became necessary.</span>"
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <motion.div {...fadeIn}>
            ...
            <div className="flex gap-12 justify-center mb-16">
              <div className="flex flex-col items-center">
                <div className="w-32 h-32 rounded-full border border-white/10 mb-6 flex items-center justify-center p-3">
                  <div className="w-full h-full rounded-full bg-gradient-to-br from-[#6B8F5E]/20 to-[#C4704A]/20 flex items-center justify-center text-2xl font-cormorant text-white/40">
                    KR
                  </div>
                </div>
                <h3 className="text-xl font-cormorant font-light mb-1">Kiran Regmi</h3>
                <p className="text-[#A3A3A3] font-inter uppercase tracking-widest text-[8px]">ID: 2070239</p>
              </div>
              
              <div className="flex flex-col items-center">
                <div className="w-32 h-32 rounded-full border border-white/10 mb-6 flex items-center justify-center p-3">
                  <div className="w-full h-full rounded-full bg-gradient-to-br from-[#C4704A]/20 to-[#6B8F5E]/20 flex items-center justify-center text-2xl font-cormorant text-white/40">
                    SM
                  </div>
                </div>
                <h3 className="text-xl font-cormorant font-light mb-1">Samyak Mahanandhar</h3>
                <p className="text-[#A3A3A3] font-inter uppercase tracking-widest text-[8px]">ID: 2070253</p>
              </div>
            </div>
            
            <p className="text-[#A3A3A3] font-inter uppercase tracking-widest text-xs mb-16">Department of CIS • Boston International College</p>
            
            <p className="text-3xl md:text-5xl font-cormorant italic leading-tight text-[#F5F5F0] max-w-4xl">
              "We built Avani because we believe <br />
