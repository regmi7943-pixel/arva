...
export default function FeaturesPage() {
  ...
  return (
    <main className="min-h-screen bg-[#1C1C1A] text-white selection:bg-[#6B8F5E]/30 selection:text-white">
      ...
      <section className="relative min-h-[70vh] flex flex-col items-center justify-center px-6 pt-24 text-center">
        ...
        >
          ...
          <p className="text-lg md:text-xl font-inter text-[#A3A3A3] font-light max-w-2xl mx-auto leading-relaxed">
            From a single leaf photo to your entire harvest forecast — this is what Avani can do.
          </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-lg font-inter text-[#A3A3A3] font-light mb-8 max-w-lg leading-relaxed">
                Powered by Gemini 1.5 Flash and advanced RAG technology, connect with an AI trained on local soil types, typical Nepalese crop cycles, and localized disease trends. Get personalized agronomy advisory available 24/7 in your pocket.
              </p>
            ...
            >
              ...
              <div className="p-4 bg-background border-t border-white/5">
                <div className="flex items-center gap-3 bg-white/5 border border-white/10 rounded-full px-2 py-2">
                  <div className="flex-1 px-4 text-xs text-[#A3A3A3]">Consulting Avani V1.0 (Gemini RAG)...</div>
      ...
      {/* 6. MARKETPLACE & DISTRIBUTION SECTION */}
      <section className="py-32 px-6 lg:px-12 bg-[#131312]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-outfit font-light mb-4">Seed-to-Sale Marketplace</h2>
            <p className="text-[#A3A3A3] font-inter font-light max-w-2xl mx-auto">
              A comprehensive ecosystem connecting you directly with what you need and who you sell to, eliminating the middlemen.
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-[#232321] border border-white/5 rounded-3xl p-8 flex flex-col items-start hover:border-[#6B8F5E]/30 transition-colors">
              <div className="w-14 h-14 rounded-2xl bg-[#6B8F5E]/10 flex items-center justify-center mb-6">
                <Store className="w-7 h-7 text-[#6B8F5E]" />
              </div>
              <h3 className="text-2xl font-outfit text-white mb-3">Local Hub Fulfillment</h3>
              <p className="text-[#A3A3A3] font-inter text-sm leading-relaxed">
                Access verified seeds, fertilizers, and equipment from local hubs near you. We ensure authenticity and quality for every input you purchase.
              </p>
            </div>

            <div className="bg-[#232321] border border-white/5 rounded-3xl p-8 flex flex-col items-start hover:border-[#C4704A]/30 transition-colors">
              <div className="w-14 h-14 rounded-2xl bg-[#C4704A]/10 flex items-center justify-center mb-6">
                <Truck className="w-7 h-7 text-[#C4704A]" />
              </div>
              <h3 className="text-2xl font-outfit text-white mb-3">Direct Distribution</h3>
              <p className="text-[#A3A3A3] font-inter text-sm leading-relaxed">
                Skip the middlemen. Connect directly with regional distributors and buyers to sell your harvest at fair, transparent market prices.
              </p>
            </div>

            <div className="bg-[#232321] border border-white/5 rounded-3xl p-8 flex flex-col items-start hover:border-[#aad19b]/30 transition-colors">
              <div className="w-14 h-14 rounded-2xl bg-[#aad19b]/10 flex items-center justify-center mb-6">
                <Sprout className="w-7 h-7 text-[#aad19b]" />
              </div>
              <h3 className="text-2xl font-outfit text-white mb-3">End-to-End Tracking</h3>
              <p className="text-[#A3A3A3] font-inter text-sm leading-relaxed">
                Track your journey from seed purchase to final sale. Avani maintains a verifiable record of your yield quality and transactions.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* 7. FINAL CTA SECTION */}
      <section className="py-40 px-6 bg-[#1C1C1A]">
